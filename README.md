...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pou4ndk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pou4ndk.containers.anotherwebservice.com/
...
```
git clone git@github.com:ramaraf221/container-pou4ndk.git
cd container-pou4ndk
```
...
```
docker attach container-pou4ndk
```
